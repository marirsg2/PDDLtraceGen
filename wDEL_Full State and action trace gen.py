...
def convert_to_state_action_list(solution_list):
    ...
    for single_action in solution_list:
        ...
        s_a_trace.append(tuple( list(curr_state) + delete_propositions + ["ACTION_"+single_action]))#the order of propositions does not matter. They all connect to each other
        prev_state = curr_state
    #---end for loop
