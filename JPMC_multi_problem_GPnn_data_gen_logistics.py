...
merged_data = []
pickle_dest_file = "JPMC_GenPlan_logistics_multiSetting.p"  # THE PICKLE file where the generated data (plan traces) are stored

all_configs= [["-c 2", "-s 4","-p 1", "-a 1"],["-c 3", "-s 4","-p 1", "-a 1"]]
for logistics_config in all_configs:
...
#---end for loop through logistics configs
