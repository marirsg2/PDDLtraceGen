...
"""
generates traces of actions only (no state fluents) along with labels which is the initial and goal state for
all packages in the logistics domain. The labels are sorted alphabetically. There maybe many plan traces for the same label.
