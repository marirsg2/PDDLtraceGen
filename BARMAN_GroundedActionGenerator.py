...
problem_file_loc = "./Blocks_pddl/TYPED_barman_problem.pddl"
pickle_dest_file =  "barman_actiongrounding.p" #THE PICKLE file where the generated data (plan traces) are stored
